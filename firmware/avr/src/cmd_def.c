...
/* { struct ble_hdr, uint32 params, ble_cmd_handler} */
static const __flash struct ble_msg apis[] ={
...
{
    const __flash struct ble_msg *msg=apis;
...
void ble_send_message(uint8 msgid,...)            
    {
        ...
        uint8 *b=(uint8 *)&packet.BLE_CMD_DATA.payload;
...
static const __flash struct ble_msg* const ble_class_system_rsp_handlers[]=
{
...
static const __flash struct ble_msg* const ble_class_system_evt_handlers[]=
{
...
static const __flash struct ble_msg* const ble_class_flash_rsp_handlers[]=
{
...
static const __flash struct ble_msg* const ble_class_flash_evt_handlers[]=
{
	&apis[ble_evt_flash_ps_key_idx],
};
static const __flash struct ble_msg* const ble_class_attributes_rsp_handlers[]=
{
...
static const __flash struct ble_msg* const ble_class_attributes_evt_handlers[]=
{
	&apis[ble_evt_attributes_value_idx],
	&apis[ble_evt_attributes_user_read_request_idx],
	&apis[ble_evt_attributes_status_idx],
};
static const __flash struct ble_msg* const ble_class_connection_rsp_handlers[]=
{
...
static const __flash struct ble_msg* const ble_class_connection_evt_handlers[]=
{
...
static const __flash struct ble_msg* const ble_class_attclient_rsp_handlers[]=
{
...
static const __flash struct ble_msg* const ble_class_attclient_evt_handlers[]=
{
...
static const __flash struct ble_msg* const ble_class_sm_rsp_handlers[]=
{
...
static const __flash struct ble_msg* const ble_class_sm_evt_handlers[]=
{
...
static const __flash struct ble_msg* const ble_class_gap_rsp_handlers[]=
{
...
static const __flash struct ble_msg* const ble_class_gap_evt_handlers[]=
{
	&apis[ble_evt_gap_scan_response_idx],
	&apis[ble_evt_gap_mode_changed_idx],
};
static const __flash struct ble_msg* const ble_class_hardware_rsp_handlers[]=
{
...
static const __flash struct ble_msg* const ble_class_hardware_evt_handlers[]=
{
...
static const __flash struct ble_msg* const ble_class_test_rsp_handlers[]=
{
...
static const __flash struct ble_msg* const ble_class_dfu_rsp_handlers[]=
{
...
static const __flash struct ble_msg* const ble_class_dfu_evt_handlers[]=
{
